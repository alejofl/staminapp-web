  ...
  <v-flex align-self-center>
    <v-card class="profile-card" elevation="5">
      <v-container>
        ...
        <v-row >
          <v-col md="12">
            <v-text-field label="E-Mail" append-icon="mail" color="secondary">
        ...
        <v-row >
          <v-col md="12">
            <v-select
              label="Género"
              v-model="this.currentUser.gender" :items="gender_options"
        ...
        <v-row >
          <v-col  md="12">
            <v-text-field
              ...
              v-model="this.currentUser.birthdate"
        ...
        <v-row>
          <v-col md="6">
            <v-text-field
              label="Peso"
              v-model="this.currentUser.weight"
          ...
          <v-col md="6">
            <v-text-field
              label="Altura"
              v-model="this.currentUser.height"
...
export default {
  ...
  data() {
    return {
      ...
      unsavedWeight: '',
      unsavedHeight: '',
      unsavedBase64Data: { type: String, default: "data:image/jpeg;base64,\n"}
    }
  },
  computed: {
